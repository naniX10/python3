...
class SungJuk2:
    ...
    def __str__(self):  # 멤버출력함수 - 매직함수
        result = f'{self.__name} {self.__kor} {self.__eng} ' \
                 f'{self.__mat} {self.__tot} ' \
                 f'{self.__mean} {self.__grd}'
        return result

    # setter getter 메서드 생성 1 >> 자바스타일
    ...
    # setter getter 메서드 생성 2
    # 파이썬에서는 @property, @setter 를 사용
    # 멤버명앞에 @를 붙여 함수의 의미를
...
sj2 = SungJuk2('둘리', 50, 50, 50)
print(sj2)

print(sj2.name)  # private 변수는 객체명.변수명으로 다룰수없음
